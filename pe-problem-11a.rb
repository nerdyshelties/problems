...
for i in 0..19 do
  for j in 0..19 do
    if i<17 then
      new=arr[i][j]*arr[i+1][j]*arr[i+2][j]*arr[i+3][j]
      if max<new then max=new end
    end
    if j<17 then
      new=arr[i][j]*arr[i][j+1]*arr[i][j+2]*arr[i][j+3]
      if max<new then max=new end
    end
    if i<17 and j<17 then
      new=arr[i][j]*arr[i+1][j+1]*arr[i+2][j+2]*arr[i+3][j+3]
      if max<new then max=new end
    end
